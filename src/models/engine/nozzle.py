...
class Nozzle():
    ...
    def __init__(self, throat, exit, efficiency, divAngle, convAngle, throatLength, slagCoeff, erosionCoeff):
        ...
        self.divAngle = divAngle # Divergence Half Angle [deg]
        self.convAngle = convAngle # Convergence Half Angle [deg]
    ...
    def calcExpansion(self):
        ...
        return (self.exit / self.throat) ** 2
    ...
    def getThroatArea(self, dThroat=0):
        ...
        return geometry.circleArea(self.throat + dThroat)

    def getExitArea(self):
        """Return the area of the nozzle's exit."""
        return geometry.circleArea(self.exit)
    ...
    def getDivergenceLosses(self):
        ...
        divAngleRad = math.radians(self.divAngle)
    ...
    def getThroatLosses(self, dThroat=0):
        ...
        throatAspect = self.throatLength / (self.throat + dThroat)
